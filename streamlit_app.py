...
# Added st.cache_data for API call resilience
...
                if price is not None and price > 0:
                    time.sleep(1) # Added sleep to respect API limits better
...
    # The prices cited in your code are used here for hardcoded resilience.
...
    # Determine a sensible price for synthesis if the API failed
    if symbol == "CFXUSD": synth_fallback = 0.315986
    elif symbol == "CVXUSD": synth_fallback = 0.09057
...
    # This section correctly defines ATR based on price magnitude
...
# Using the fixed, cached API function
...
# This column structure is where the asset name and currency input fields are located.
